...
namespace LinkedSquad.PlayerControls
{
    ...
    public class FP_CameraLook : MonoBehaviour
    {
        ...
        public Vector3 CameraForward => headBob.MainCamera.forward;
        ...
        private void Start()
        {
            ...
            LookSensitivity = PlayerPrefs.GetFloat("Sensitivity", 2f);
        ...
        private void Update()
        {
            ...
            if (playerInput.InventoryButton())
                return;
